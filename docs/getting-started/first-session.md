...
New to AVATAR? Prefer the [Windows installer](https://github.com/ARPAHLS/avatar/releases/download/v0.6.0/AVATAR-Setup-0.6.0.exe) when you can. Otherwise see [Installation](installation.md).
