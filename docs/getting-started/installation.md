...
**[AVATAR-Setup-0.5.0.exe](https://github.com/ARPAHLS/avatar/releases/download/v0.5.0/AVATAR-Setup-0.5.0.exe)**

Also listed on [Releases](https://github.com/ARPAHLS/avatar/releases/tag/v0.5.0). Accept the EULA, finish the wizard, launch **AVATAR**.
