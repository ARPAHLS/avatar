...
- Auto-contrast glass bar chrome (white on dark scenes, silver/greyscale on light).
...
- Docs: Electron-first install & first session, [avatars & skins](docs/avatars-and-skins.md), [environments](docs/environments.md), [assets & credits](docs/assets-and-credits.md) (VRoid / BOOTH / Pixiv terms, `input@arpacorp.net`).
